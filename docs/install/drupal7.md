...
There is also a Drupal 7 distribution which includes CiviCRM, [CiviCRM Starterkit](https://www.drupal.org/project/civicrm_starterkit), which is available as a (nearly) [one-click install](https://dashboard.pantheon.io/products/civicrm_starterkit/spinup) on the [Pantheon](https://pantheon.io/) hosting service, with [documentation on www.drupal.org](https://www.drupal.org/node/1694794).
